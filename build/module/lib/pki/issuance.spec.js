...
import { issueDeliveryAuthorization, issueEndpointCertificate, issueGatewayCertificate, } from './issuance';
...
describe('issueGatewayCertificate', () => {
    ...
    test('Certificate should have its private address as its Common Name (CN)', async () => {
        ...
        expect(mockCertificateIssue.mock.calls[0][0]).toHaveProperty('commonName', `0${await getPublicKeyDigestHex(stubSubjectKeyPair.publicKey)}`);
    });
