    ...
    describe('Additional requirements', () => {
        describe('Deserialization', () => {
            ...
            test('Parcels larger than the maximum legal size should be refused', async () => {
                ...
                await expect(Parcel.deserialize(parcelSerialized)).rejects.toEqual(new InvalidMessageError(`Parcels must not span more than ${CargoMessageSet.MAX_MESSAGE_LENGTH} octets ` +
