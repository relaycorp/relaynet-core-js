...
describe('serialize', () => {
    ...
    test('One signature', () => {
        ...
        expectArrayBuffersToEqual(SIGNATURE1, nonceSignaturesASN1.valueBlock.value[0].valueBlock.valueHex);
    });
    test('Two signatures', () => {
        ...
        expectArrayBuffersToEqual(SIGNATURE2, nonceSignaturesASN1.valueBlock.value[1].valueBlock.valueHex);
    });
});
describe('deserialize', () => {
    test('Invalid serialization should be refused', () => {
        ...
        expect(() => HandshakeResponse.deserialize(invalidSerialization)).toThrowWithMessage(InvalidMessageError, 'Handshake response is malformed');
    });
