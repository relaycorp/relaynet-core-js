...
describe('serialize', () => {
    test('Nonce should be sole item in ASN.1 SEQUENCE', () => {
        ...
        expectArrayBuffersToEqual(NONCE, sequence.valueBlock.value[0].valueBlock.valueHex);
    });
});
describe('deserialized', () => {
    test('Invalid serialization should be refused', () => {
        ...
        expect(() => HandshakeChallenge.deserialize(invalidSerialization)).toThrowWithMessage(InvalidMessageError, 'Handshake challenge is malformed');
    });
